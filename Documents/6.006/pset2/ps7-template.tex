...
An algorithm to find a compatible roommate is as follows in O(m to the power log 3). First, represent A, B and C as a sequence of 0-1 coefficients of a polynomial. By multiplying the polynomials A and B, the exponents would be added up. If the product contains any of the terms from the polynomial C, then this would mean that there is some a in A, b in B and c in C for which a + b = c. 
